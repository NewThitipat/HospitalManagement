...
(10001, 'Loratadine', 'Tablet', 'Relieve the symptoms of allergies.', 128, 'Blister pack', 70),
(20001, 'Codeine', 'Liquid', 'Treat mild-to-moderate pain', 66, 'Bottle', 90),
...
(30005, 'Warfarin', 'Tablet', 'A vitamin K antagonist for venous thromboembolism.', 61, 'Blister pack', 100),
(40001, 'Aprepitant', 'capsules', 'Treat nausea and vomiting.', 138, 'Blister pack', 90),
(40002, 'Metoclopramide', 'Tablet', 'Treat gastroesophageal reflux disease.', 188, 'Blister pack', 90),
(40003, 'Ondansetron', 'Tablet', 'Prevent nausea and vomiting in chemotherapy.', 80, 'Blister pack', 90),
...
(65000, '1.9199E+12', 'Miss', 'Jean-Luckier', 'Whitehouse', 'F', '2019-03-04', '0674409814', '9 Vine Court, Fakenham 10140'),
...
(65024, '1.9199E+12', 'Mister', 'Deniz', 'O\'Brien', 'M', '2005-03-01', '0869406325', '5 Ffordd Deg, Llanbedrgoch'),
...
CREATE ALGORITHM = UNDEFINED VIEW `age`  AS SELECT `patient`.`Patient_DOB` AS `Patient_DOB`, timestampdiff(YEAR,`patient`.`Patient_DOB`,curdate()) AS `old` FROM `patient`  ;
...
--
ALTER TABLE `appointment`
  MODIFY `AP_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=300021;

--
-- AUTO_INCREMENT for table `bill`
--
ALTER TABLE `bill`
  MODIFY `Bill_no` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=990032;

--
-- AUTO_INCREMENT for table `ipd`
--
ALTER TABLE `ipd`
  MODIFY `ipd_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20002;
...
--
ALTER TABLE `opd`
  MODIFY `OPD_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10052;

--
-- AUTO_INCREMENT for table `opd_treatment`
--
ALTER TABLE `opd_treatment`
  MODIFY `TM_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110043;

--
-- AUTO_INCREMENT for table `patient`
--
ALTER TABLE `patient`
  MODIFY `Patient_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65101;

--
-- AUTO_INCREMENT for table `prescription`
--
ALTER TABLE `prescription`
  MODIFY `Pre_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=200060;
